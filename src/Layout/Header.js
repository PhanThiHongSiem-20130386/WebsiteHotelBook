          ...
          <div className="collapse navbar-collapse offset justif justify-content-center" id="navbarSupportedContent">
            <ul className="nav navbar-nav menu_nav ml-auto">
              ...
              <li className={`nav-item submenu dropdown ${active.includes('/room') ? 'active' : ''}`}>
                <a href="#in" className="nav-link dropdown-toggle " data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">ROOM <span className="lnr lnr-chevron-down"></span></a>
                <ul className="dropdown-menu">
                  <li className={`nav-item ${getActiveClass('/standard')}`}><NavLink className="nav-link" onClick={() => setActive('/room')} to="/blog">Standard</NavLink></li>
                  <li className={`nav-item ${getActiveClass('/superior')}`}><NavLink className="nav-link" onClick={() => setActive('/room')} to="/blog">Superior</NavLink></li>
                  <li className={`nav-item ${getActiveClass('/deluxe')}`}><NavLink className="nav-link" onClick={() => setActive('/room')} to="/blog-">Deluxe</NavLink></li>
                  <li className={`nav-item ${getActiveClass('/suite')}`}><NavLink className="nav-link" onClick={() => setActive('/room')} to="/blog">Suite</NavLink></li>
                </ul>
              </li> 
