          ...
          <div className="d-flex w-full flex-col pb-8 ">
            <div className="relative d-flex flex-col justify-between p-4 sm:flex-row row">
              ...
              <div className="d-flex">
                ...
                <span className="text-black font-weight-bold">0362113708</span>
              </div>
              <div className="d-flex">
            ...
            <div className="relative d-flex flex-col justify-between p-4 sm:flex-row row">
              <div className="d-flex">
                ...
                <span className="text-black font-weight-bold"> 1.220.000Đ</span>
              </div>
              <div className="d-flex">
              ...
              <div className="d-flex">
                ...
                <span className="text-black font-weight-bold"> Thành công</span>
              </div>
            </div>
          </div>
                ...
                <div className="row justify-content-center">
                  <div className="col-10 col-md-8 col-lg-6">
                    <div className="p-4 border rounded bg-white">
                      ...
                      <div className="d-flex">
                        <div className="text-black mb-2 col-7">Thời gian nhận phòng: </div>
                        <span className="text-black font-weight-bold">
                          1/1/2023 
                        </span>
                      </div>
                      <div className="d-flex">
                        <div className="text-black mb-2 col-7">Thời gian trả phòng: </div>
                        <span className="text-black font-weight-bold">
                          2/1/2023 
                        </span>
                      </div>
                      <div className="d-flex">
                        <div className="text-black mb-2 col-7">Loại phòng: </div>
                        <span className="text-black font-weight-bold">
                          Phòng view bãi biển
                        </span>
                      </div>
